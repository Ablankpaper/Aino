...
class TestFTS5Search:
    ...
    def test_search_projection_skips_context_enrichment_queries(
        ...
        @contextmanager
        def traced_read_ctx():
            # The read pool may rotate connections between calls. Trace the
            # connection actually leased for each query instead of guessing
            # which pooled handle will be selected next.
