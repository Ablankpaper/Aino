...
// shared soft radius and UI text, padding-driven sizing (no fixed heights). The visual
...
export const controlVariants = cva(
  'desktop-input-chrome w-full min-w-0 rounded-(--aino-radius-control) border text-[length:var(--aino-text-ui)] leading-4 text-foreground outline-none placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      size: {
