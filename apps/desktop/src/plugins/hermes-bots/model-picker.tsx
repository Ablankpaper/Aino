      ...
      <div className="grid grid-cols-2 gap-2.5">
        {labeled(
          ...
          <Input
            ...
            placeholder={b.model.providerPlaceholder}
        ...
        {labeled(
          ...
          <Input
            ...
            placeholder={b.model.modelPlaceholder}
            value={value.model}
          />
        )}
      </div>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {labeled(
            ...
            <Input
              ...
              placeholder={b.model.providerCustomPlaceholder}
              value={value.provider}
            />
          )}
          {labeled(
            ...
            <Input
              ...
              placeholder={b.model.modelCustomPlaceholder}
              value={value.model}
            />
          )}
        </div>
    ...
    <div className="grid grid-cols-[1fr_1.4fr] gap-2.5">
      {labeled(
        ...
        >
          ...
          <SelectContent>
            <SelectItem value={NONE}>{b.model.inheritLaunch}</SelectItem>
            {providers.map(p => (
