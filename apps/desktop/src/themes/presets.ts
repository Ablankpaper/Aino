...
const SYSTEM_SANS =
  '"PingFang SC", "Microsoft YaHei UI", "Noto Sans CJK SC", -apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif, ' +
  EMOJI_FALLBACK
...
/** Aino Desktop's fixed neutral palette; brightness is selected separately. */
