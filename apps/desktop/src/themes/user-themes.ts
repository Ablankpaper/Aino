 ...
 *
 * Legacy assets remain available to converters and plugin previews. Aino's
 * ThemeProvider uses its fixed palette and does not apply registry themes.
 * Keeping this storage preserves installed resources across the UI change.
 */
