...
export const ar = defineLocale({
  ...
  settings: {
    ...
    account: {
      ...
      legalDevelopmentNotice: 'هذه نسخة تطوير محلية. لم تُنشر الشروط وسياسة الخصوصية النهائية بعد. هذا الإشعار لاختبار تسجيل الدخول وليس اتفاقاً ملزماً. تُحفظ الحسابات التجريبية على الخادم المتصل، ولا تُرسل رسائل نصية أو بريد إلكتروني.',
