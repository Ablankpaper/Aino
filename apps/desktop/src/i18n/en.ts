...
export const en: Translations = {
  ...
  platformModels: {
    ...
    platform_account_changed: "This model belongs to another account. Sign in to the original account or choose a model again.",
...
summarizing: 'Summarizing thread',
  ...
  desktop: {
    ...
    platformVisionUnsupported: 'This Aino model cannot accept images. Choose an image-capable model; your draft and attachments are preserved.',
