...
export const ru = defineLocale({
  ...
  settings: {
    ...
    account: {
      ...
      legalDevelopmentNotice: 'Это локальная версия для разработки. Окончательные условия и политика конфиденциальности ещё не опубликованы. Это уведомление служит для тестирования входа и не является договором. Тестовые аккаунты хранятся на подключённом сервере; SMS и письма не отправляются.',
