...
export const zh: Translations = {
  ...
  keybinds: {
    ...
    actions: {
      ...
      'profile.default': '切换到默认配置档案',
      'profile.switch.1': '切换到配置档案 1',
      'profile.switch.2': '切换到配置档案 2',
      'profile.switch.3': '切换到配置档案 3',
      'profile.switch.4': '切换到配置档案 4',
      'profile.switch.5': '切换到配置档案 5',
      'profile.switch.6': '切换到配置档案 6',
      'profile.switch.7': '切换到配置档案 7',
      'profile.switch.8': '切换到配置档案 8',
      'profile.switch.9': '切换到配置档案 9',
      'profile.switch.10': '切换到配置档案 10',
      'profile.switch.11': '切换到配置档案 11',
      'profile.switch.12': '切换到配置档案 12',
      'profile.switch.13': '切换到配置档案 13',
      'profile.switch.14': '切换到配置档案 14',
      'profile.switch.15': '切换到配置档案 15',
      'profile.switch.16': '切换到配置档案 16',
      'profile.switch.17': '切换到配置档案 17',
      'profile.switch.18': '切换到配置档案 18',
      'profile.next': '下一个配置档案',
      'profile.prev': '上一个配置档案',
      'profile.toggleAll': '切换全部配置档案视图',
      'profile.create': '创建配置档案',
      'composer.send': '发送消息',
  ...
  settings: {
    ...
    managedUpdates: {
      ...
      scopesRestored: (profiles: string) => `已恢复的配置档案：${profiles}`,
    ...
    gateway: {
      ...
      envOverride: '环境变量覆盖',
      intro:
        'Hermes 桌面端默认会启动自己的本地网关。当你希望此应用控制另一台机器上或可信代理后的现有 Hermes 后端时，可以使用远程网关。网关连接属于本机级设置；配置档案是从所连接的网关中发现的。',
    ...
    memory: {
      ...
      fullConfigDescription: (label, profile) =>
        `${profile} 配置档案的全部 ${label} 选项。留空时使用解析后的主机设置或内置默认值。`,
  ...
  profiles: {
    ...
    nameRequired: '名称为必填项。',
    profileNameRequired: '需要配置档案名称',
    defaultProfileDeleteBlocked: '无法删除默认配置档案。',
    creating: '创建中…',
    createAction: '创建配置档案',
    renameTitle: '重命名配置档案',
  ...
  sidebar: {
    ...
    row: {
      ...
      ownedByProfile: profile => `配置档案：${profile}`,
      renamed: '已重命名',
      renameFailed: '重命名失败',
      renameTitle: '重命名会话',
      renameDesc: '留空则清除。',
  ...
  composer: {
    ...
    commandDescs: {
      ...
      '/export': '将配置档案（配置、技能、主题）导出为可分享归档',
      '/import': '将共享配置档案归档导入为新配置档案',
      '/stop': '终止所有正在运行的后台进程',
