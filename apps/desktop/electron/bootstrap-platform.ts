...
function resolveDesktopAccountAdapter({ isPackaged, argv }: { isPackaged: boolean; argv: string[] }) {
  return !isPackaged && argv.includes('--aino-legacy-account-development') ? 'legacy-development' : 'platform'
}
