...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Aino' : 'Setting up Aino Agent'

  const description = isUpdate
    ? 'Aino is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Aino installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
